...
Website Link: https://leetcode.com/problems/strictly-palindromic-number/

Modification Log: 
Date					Name                                            Description
Sep 27, 2022			Chandra Sekhar Reddy Muthumula					Added Class StrictlyPalindromicNumber 
Sep 27, 2022			Chandra Sekhar Reddy Muthumula					Added isStrictlyPalindromic 
--------------------------------------------------------------------------------------------------
...
class StrictlyPalindromicNumber {
    ...
    //         if(!isPalindromeNumber(digits)){
    //             return false;
    //         }
    //     }
    //     return true;
    // }
    // public boolean isPalindromeNumber(List<Integer> n) {
    //      int start = 0;
    //      int end = n.size() - 1;
    //      while(start <= end) {
