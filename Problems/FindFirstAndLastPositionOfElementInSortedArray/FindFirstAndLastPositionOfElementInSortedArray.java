...
Dec 22, 2022			Chandra Sekhar Reddy Muthumula					Added searchRangeBestApproach
Dec 22, 2022			Chandra Sekhar Reddy Muthumula					Added binarySearch
--------------------------------------------------------------------------------------------------
...
public class FindFirstAndLastPositionOfElementInSortedArray {
    ...
    public int[] searchRangeBestApproach(int[] nums, int target) {
        int len = nums.length;
        // This is an edge case where the length of nums is 1 and the target is matching
        if(len == 1) {
            if(target == nums[0]) {
