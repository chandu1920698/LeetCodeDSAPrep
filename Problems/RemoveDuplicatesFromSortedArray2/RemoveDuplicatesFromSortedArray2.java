/*
Class Name  : RemoveDuplicatesFromSortedArray2
Description : This class consists of the solution for RemoveDuplicatesFromSortedArray2.
Created Date: Mar 14, 2022
Author      : Chandra Sekhar Reddy Muthumula
Website Link: https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/description/
Modification Log: 
...
public class RemoveDuplicatesFromSortedArray2 {
    ...
    public int removeDuplicatesBestApproach(int[] nums) {  
        /* 
        * TC : O(N)
        * SC : O(1)
        */  
