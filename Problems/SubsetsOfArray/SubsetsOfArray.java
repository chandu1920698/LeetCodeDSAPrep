...
Sep 14, 2022			Chandra Sekhar Reddy Muthumula					Added Class SubsetsOfArray 
...
public class SubsetsOfArray {
	public static void main (String[] args) {
		// Test Cases
		solutionMethod(new int [] {1,2,3});
		System.out.println("--------------------------------------------------");
		solutionMethod(new int [] {4,2,3});
		System.out.println("--------------------------------------------------");
		solutionMethod(new int [] {1,5,7,8,4,2,3});
		System.out.println("--------------------------------------------------");
	}
	
	public static void solutionMethod (int[] arr) {
		if (arr.length <= 0) {
